...
let run = async () => {
  ...
  let experience_profile = await client.Database.createCollection("experience_profile")
  experience_profile.insertOne({
    "isEnabled": true,
    "entity": { "name": "company A", "did": "did:elastos:iag8qwq1xPBpLsGv4zR4CmzLpLUkBNfPHX" },
  ...
  let education_profile = await client.Database.createCollection("education_profile")
