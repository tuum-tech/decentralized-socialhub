...
const OnBoarding: React.FC<Props> = ({
      ...
      >
        ...
        <div className={clsx(style['stage2-content'], style['v-flex'])}>
          <p>
            ...
            responsibility, you own them, and we store nothing. You must protect
            and store your secret keys(also known as mnemonics)! These secret
            keys are used to issue a unique Decentralized Identifier (DID) and
        ...
        >
          ...
          <div className={clsx(style['stage5-content'], style['v-flex'])}>
            <div className={clsx(style['avatar-container'], style['v-flex'])}>
              <Avatar did={sessionItem.did} ready={true} />
  ...
  return (
    <AlphaContent>
      ...
      {stage === 1 && !sessionItem.onBoardingCompleted && step1Item()}
      {stage === 2 && !sessionItem.onBoardingCompleted && step2Item()}
      {stage === 3 && !sessionItem.onBoardingCompleted && step3Item()}
      {stage >= 4 && !sessionItem.onBoardingCompleted && step4Item()}
    </AlphaContent>
  );
};
