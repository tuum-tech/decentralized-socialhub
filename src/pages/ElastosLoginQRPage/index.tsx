 ...
 * Page
 */
import { IonHeader, IonPage, IonImg, IonRouterLink } from '@ionic/react';
...
const ElastosLoginQRPage: React.FC<InferMappedProps> = ({
  eProps,
  ...props
}: InferMappedProps) => {
  /**
          ...
          <div className={style['qr-frame']}>
            <IonRouterLink href='/profile' routerDirection='forward'>
              <IonImg
                ...
                style={{ width: '98.5%', marginTop: '2px', padding: 'auto' }}
              />
            </IonRouterLink>
          </div>
 ...
 */
const withInjectedMode = injector(ElastosLoginQRPage, {
  key: NameSpace,
  reducer,
  saga,
});
