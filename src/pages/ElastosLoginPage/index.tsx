...
const ElastosLoginPage : React.FC<InferMappedProps> = ({ eProps, ...props }: InferMappedProps) => {
  ...
  */
  ...
  return (
    <IonPage className={style["elastosloginpage"]}>
      <IonHeader>
        <IonToolbar>
          <IonTitle>Login with Elastos</IonTitle>
        </IonToolbar>
      </IonHeader>
      <IonContent>
      <IonCard className="welcome-card">
          <IonCardHeader>
            <IonCardSubtitle>Login with Elastos</IonCardSubtitle>
          </IonCardHeader>
          <IonCardContent>
