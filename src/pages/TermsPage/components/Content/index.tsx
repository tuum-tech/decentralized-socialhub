  ...
  return (
    <>
      ...
      <Section ref={sectionRefs[0]}>
        ...
        <SectionText>
          <p>
            These Terms and Conditions (“Terms of Use”) constitute a legally
            binding agreement made between you, whether personally or on behalf
            of an entity (“you”) and Blockchain Limited dba Tuum Technologies
            and its affiliates (“we,” “us” or “our”), concerning your access to
            and use of the Profile Platform, a website and platform owned by
            Blockchain Limited dba Tuum Technologies, as well as any other media
            form, media channel, application, mobile website or mobile
            application related, linked, or otherwise connected thereto,
            existing now or created at a later date (collectively, the
            “Platform”). You agree that by accessing the Platform, you have
        ...
        <SectionText>
          ...
          <p>
            ...
            revised Terms of Use by your continued use of the Platform after the
            date such revised Terms are posted.
          </p>
          <p>
      ...
      <Section ref={sectionRefs[1]}>
        ...
        <SectionText>
          <p>
            Profile is a consumer product that provides individuals access to a
            secure digital identity, and personal data ownership, on an
            inclusive web-based platform powered by blockchain technology.
            Profile is based on Elastos open-sourced software that provides
            self-sovereign identity, verified credentials, and a
            semi-decentralized data storage solution. This revolutionary
            verified digital profile is one of the first in existence controlled
            entirely by the user. No personal information will be stored on the
            platform or our servers, unless Tuum Technologies vault is selected
      ...
      <Section ref={sectionRefs[2]}>
        ...
        <SectionText>
          <p>
            We care about data privacy and security. Please review our TUUM
            Privacy Policy at&nbsp;
            <IonRouterLink href="https://tuum.tech/privacy-policy/">
              <PrimaryText>https://tuum.tech/privacy-policy/</PrimaryText>
            </IonRouterLink>
            &nbsp;which governs the Platform (the “Privacy Policy”).
          </p>
          <p>
            By using the Platform, you agree to be bound by our Privacy Policy,
            which is incorporated by reference into these Terms of Use. Please
            be advised the Platform is hosted in the United States. If you
            access the Platform from the European Union, Asia, or any other
            ...
            use of the Platform, you are transferring your data to the United
      ...
      <Section ref={sectionRefs[3]}>
        ...
        <SectionText>
          <p>
            ...
            Platform (collectively, the “Content”) and the trademarks, service
            ...
            Use, no part of the Platform and no Content or Marks may be copied,
      ...
      <Section ref={sectionRefs[4]}>
        ...
        <SectionText>
          <p>
            ...
            of Use; (4) you are not under the age of 13; (5) not a minor in the
            jurisdiction in which you reside, or if a minor, you have received
            parental permission to use the Platform; (6) you will not access the
            Platform through automated or non-human means, whether through a
            bot, script or otherwise; (7) you will not use the Platform for any
            illegal or unauthorized purpose; and (8) your use of the Platform
      ...
      <Section ref={sectionRefs[5]}>
        ...
        <SectionText>
          <p>
            ...
            your DID and/or username, private keys, and password confidential
            and will be responsible for all use of your account and password. In
            the event DIDs are not used, we reserve the right to remove,
      ...
      <Section ref={sectionRefs[6]}>
        ...
        <Indent>
          ...
          <p>
            2. make any unauthorized use of the Platform, including collecting
            DIDs, usernames and/or email addresses of users by electronic or
          ...
          <p>
            4. use the Platform to advertise or offer to sell goods and
            services.
          </p>
          <p>
          ...
          <p>
            13. use any information obtained from the Platform in order to
            harass, abuse, or harm another person.
          </p>
          <p>
            14. use the Platform as part of any effort to compete with us or
          ...
          <p>
            19. copy or adapt the Platform’s software, including but not limited
          ...
          <p>
            24. use the Platform in a manner inconsistent with any applicable
            laws or regulations.
          </p>
        </Indent>
      </Section>
      <Section ref={sectionRefs[7]}>
        ...
        <SectionText>
          <p>
            ...
            in blogs, quizzes, code development, message boards, online forums,
            ...
            Platform, including but not limited to text, code, writings, video,
            ...
            users of the Platform and through third-party websites. As such, any
      ...
      <Section ref={sectionRefs[9]}>
        <SectionTitle>MOBILE APPLICATION LICENSE(as applicable)</SectionTitle>
        <SectionSubTitle>User License</SectionSubTitle>
        <SectionText>
          <p>
            If you download the Platform via a mobile application, then we grant
            ...
            application which is not labeled as “open source”; (2) make any
        ...
        <SectionText>
          <p>
            ...
            Distributor”) to access the Platform: (1) the license granted to you
      ...
      <Section ref={sectionRefs[10]}>
        ...
        <SectionText>
          <p>
            You acknowledge and agree that any questions, comments, quiz
            answers, polls, suggestions, ideas, feedback, or other information
            regarding the Platform (&quot;Submissions&quot;) provided by you to
            us are non- confidential and shall become our sole property. We
            ...
            you. You hereby waive all moral rights to any such Submissions, and
            you hereby warrant that any such Submissions are original with you
            or that you have the right to submit such Submissions. You agree
      ...
      <Section ref={sectionRefs[11]}>
        ...
        <SectionText>
          <p>
            ...
            installed from the Platform, including the content, accuracy,
            ...
            decide to leave the Platform and access the Third-Party Websites or
            to use or install any Third-Party Content, you do so at your own
            risk, and you should be aware these Terms of Use no longer govern.
            ...
            navigate from the Platform or relating to any applications you use
            or install from the Platform. Any purchases you make through
      ...
      <Section ref={sectionRefs[13]}>
        ...
        <SectionText>
          <p>
            ...
            to remove from the Platform or otherwise disable all files and
      ...
      <Section ref={sectionRefs[14]}>
        ...
        <SectionText>
          ...
          <p>
            ...
            infringed, or, if multiple copyrighted works on the Platform are
            covered by the Notification, a representative list of such works on
            the Platform; (3) identification of the material that is claimed to
        ...
        <SectionText>
          <p>
            ...
            the Platform as a result of a mistake or misidentification, you may
            ...
            party&#39;s agent; (4) your name, address, and telephone number; (5)
      ...
      <Section ref={sectionRefs[15]}>
        ...
        <SectionText>
          <p>
            ...
            (INCLUDING BLOCKING CERTAIN IP ADDRESSES OR ELASTOS DIDS), TO ANY
      ...
      <Section ref={sectionRefs[17]}>
        ...
        <SectionText>
          <p>
            These Terms of Use and your use of the Platform are governed by and
      ...
      <Section ref={sectionRefs[18]}>
        ...
        <SectionText>
          <p>
            ...
            for at least 45 days before initiating arbitration. Such informal
        ...
        <SectionText>
          <p>
            To expedite resolution and control the cost of any dispute,
            controversy or claim related to these Terms of Use (each a
            &quot;Dispute&quot; and collectively, “Disputes”), any Dispute
            ...
            law, the arbitration will take place in New Hanover County, North
            Carolina. Except as otherwise provided herein, the Parties may
          ...
          <p>
            ...
            state and federal courts located in New Hanover County, North
            Carolina, and the Parties hereby consent to, and waive all defenses
      ...
      <Section ref={sectionRefs[20]}>
        ...
        <SectionText>
          <p>
            ...
            AGREE THAT YOUR USE OF THE PLATFORM SERVICES WILL BE AT YOUR SOLE
      ...
      <Section ref={sectionRefs[22]}>
        ...
        <SectionText>
          <p>
            ...
            your Contributions; (2) use of the Platform; (3) breach of these
      ...
      <Section ref={sectionRefs[26]}>
        ...
        <SectionText>
          <p>
            ...
            on the Platform constitute the entire agreement and understanding
            ...
            of the Platform. You agree that these Terms of Use will not be
