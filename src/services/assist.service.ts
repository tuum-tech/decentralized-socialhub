...
export class AssistService {
  static async publishDocument(
    ...
    let url = `${process.env.REACT_APP_ASSIST_API_SERVICE_URL}/didtx/create`;
    let data = {
      didRequest: request,
  ...
  static async getRequestStatus(
    ...
    let url = `${process.env.REACT_APP_ASSIST_API_SERVICE_URL}/didtx/confirmation_id/${confirmationId}`;
