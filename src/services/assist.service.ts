...
export class AssistService {
    ...
    static async publishDocument(did: string, request: any): Promise<IPublishDocumentResponse> {
    ...
    static async getRequestStatus(confirmationId: string) : Promise<IPublishDocumentResponse> {
